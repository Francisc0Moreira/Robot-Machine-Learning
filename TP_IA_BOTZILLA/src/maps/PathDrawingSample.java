...
public class PathDrawingSample {
    ...
    public final static int mutationRate = 20; // número a alterar em cada mutação
    public final static int popSize = 1000; // tamanho da população
    public final static int popHereditary = 500; // soluções a manter
    public final static int popMutation = 200; // soluções a gerar por mutação
    public final static int popCross = 300; // soluções a gerar por cruzamento
    public final static int maxIterations = 2000; // critério de paragem
    ...
    private static List<List<IPoint>> selectBestIndividuals(List<List<IPoint>> population, int numToSelect) {
